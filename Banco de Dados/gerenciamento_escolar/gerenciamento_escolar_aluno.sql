...
CREATE TABLE `aluno` (
  ...
  `uf_rg_responsavel` varchar(45) DEFAULT NULL,
  `dt_nascimento_responsavel` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `aluno` VALUES (2,'Dilma',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);
